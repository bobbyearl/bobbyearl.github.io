...
. "\n" . '		<a class="clickable" clicktoshow="loading" clicktohide="content" onclick="fUpdateContent(\'funny\');return false;">'
. "\n" . '			%2$s'
. "\n" . '		</a>'
. "\n" . '	</li>'
. "\n" . '	<li style="float: left; list-style: none; padding: 10px; text-align: center; width: %1$spx;">'
. "\n" . '		<a class="clickable" clicktoshow="loading" clicktohide="content" onclick="fUpdateContent(\'flash\'); return false;">'
. "\n" . '			%3$s'
. "\n" . '		</a>'
. "\n" . '	</li>'
. "\n" . '	<li style="float: left; list-style: none; padding: 10px; text-align: center; width: %1$spx;">'
